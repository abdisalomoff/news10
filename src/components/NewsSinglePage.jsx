...
const NewsSinglePage = () => {
  ...
  useEffect(() => {
    dispatch(fetchData(`https://api.spaceflightnewsapi.net/v3/articles/${articleId}`));
  }, []);
    ...
    <div className="container">
      ...
      <div className="mt-3 w-50 mx-auto">
        <div className="card-body gap-3 p-0">
            ...
            <img className="article-img my-3" src={dataState.data.imageUrl} alt={dataState.data.title} />
        </div>
        <div className="card-footer d-flex justify-content-between align-items-center fs-6">
          <p className="newssite m-0 text-primary"> {dataState.data.newsSite}</p>
